-- ===========================================================================
-- F007 Enhancement: Fallback naar plaintext qr_code voor legacy tickets
-- ===========================================================================
--
-- RATIONALE:
-- Als een ticket om een of andere reden geen token_hash heeft, probeer dan
-- ook te zoeken op plaintext qr_code. Dit zorgt voor backwards compatibility.
--
-- Na het vinden van zo'n ticket, update de hash zodat volgende scans snel zijn.
--
-- ===========================================================================
...
COMMENT ON FUNCTION public.scan_ticket IS
  'F007: Professional ticket scanning with fallback for legacy tickets';
...
DO $$
BEGIN
  RAISE NOTICE 'F007 Enhancement: scan_ticket now has plaintext fallback';
  RAISE NOTICE '  - Fast: token_hash lookup (indexed)';
  RAISE NOTICE '  - Fallback: qr_code plaintext for legacy tickets';
  RAISE NOTICE '  - Auto-fix: Legacy tickets get hash on first scan';
END $$;
