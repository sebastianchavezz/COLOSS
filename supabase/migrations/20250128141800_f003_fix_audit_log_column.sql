-- Fix audit_log column names in event_routes RPCs
-- Original audit_log schema uses: resource_type, resource_id, user_id
-- Not: entity_type, entity_id, actor_user_id

-- ============================================================================
-- RPC: set_event_route_status (fixed)
-- ============================================================================
...
BEGIN
    ...
    -- Audit log (fixed: actor_user_id instead of actor_id)
